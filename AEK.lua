...
local Text = '*𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝚂𝙾𝚄𝚁𝙲𝙴*\n║▌│█║▌│ █║▌│█│║▌║\n🇦.🇪.🇰.🇦.🇳❦🇻.🇮.🇵\n║▌│█║▌│ █║▌│█│║▌║\n*𝙿𝚁𝙴𝚂𝚂 𝚃𝙷𝙴 𝙱𝚄𝚃𝚃𝙾𝙽𝚂 𝙳𝙾𝚆𝙽*'
keyboard = {} 
keyboard.inline_keyboard = {
